...
void Sparsifier::JacobianSE3XYZ(const g2o::SE3Quat KF, const g2o::Vector3D MP, Eigen::Matrix<double, 3, 9>& J)
{
...
void Sparsifier::HessianSE3XYZ(const g2o::SE3Quat KF, const g2o::Vector3D MP,
...
void Sparsifier::DoMarginalizeSE3XYZ(
    const std::vector<g2o::SE3Quat, Eigen::aligned_allocator<g2o::SE3Quat>>& vKF,
...
void Sparsifier::JacobianSE3(const g2o::SE3Quat KF1, const g2o::SE3Quat KF2, Eigen::Matrix<double, 6, 12>& J)
{
...
void Sparsifier::InfoSE3(const g2o::SE3Quat KF1, const g2o::SE3Quat KF2,
                         const Eigen::Matrix<double, 12, 12>& H, Eigen::Matrix<double, 6, 6>& I)
{
